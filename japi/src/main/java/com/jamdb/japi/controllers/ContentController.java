...
public class ContentController {
    ...
    @GetMapping("/search")
    public ResponseEntity<List<ContentDetailsDto>> getContentOnQuery(
        ...
        return ResponseEntity.ok(contentService.getContentBySearchParams(search, tag, year, season, status, type));
    }
